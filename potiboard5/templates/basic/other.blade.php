...
<head>
	...
	<title>@if($post_mode) @if(!$rewrite) @if(!$admin_del) @if(!$admin) 投稿フォーム @endif @endif @endif @endif @if($rewrite)
		編集モード @endif @if($admin_in) 管理用 @endif @if($admin) @if($rewrite) - @endif @endif @if($admin) 管理人による投稿 @endif
...
<body>
	<div id="body">
		<header>
			<h1 id="bbs_title">@if(!$rewrite) @if(!$admin_del) @if(!$admin) 投稿フォーム @endif @endif @endif @if($rewrite)
				編集モード @endif @if($admin_in) 管理用 @endif @if($admin) @if($rewrite) - @endif @endif @if($admin) 管理人による投稿
