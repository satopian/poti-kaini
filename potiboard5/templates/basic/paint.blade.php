...
async function PaletteMatrixGet(){var a=Palettes.length,b=document.forms.namedItem("Palette");if(b){var c=b.elements.namedItem("select");if(c instanceof HTMLSelectElement){var e=b.elements.namedItem("m_m");e=e instanceof HTMLSelectElement?e.selectedIndex:null;if((b=b.elements.namedItem("setr"))&&b instanceof HTMLTextAreaElement){switch(e){default:b.value="";let d=e=0;for(;a>e;)c.options[e]!=null&&(b.value=b.value+"\n!"+c.options[e].text+"\n"+Palettes[e],d++),e++;alert("\u30d1\u30ec\u30c3\u30c8\u6570\uff1a"+
d+"\n\u30d1\u30ec\u30c3\u30c8\u30de\u30c8\u30ea\u30af\u30b9\u3092\u53d6\u5f97\u3057\u307e\u3057\u305f");break;case 1:b.value="!Palette\n"+String(await document.paintbbs.getColors()),alert("\u73fe\u5728\u4f7f\u7528\u3055\u308c\u3066\u3044\u308b\u30d1\u30ec\u30c3\u30c8\u60c5\u5831\u3092\u53d6\u5f97\u3057\u307e\u3057\u305f")}b.value=b.value.trim()+"\n!Matrix"}}}}
function PalleteMatrixSet(){var a=document.forms.namedItem("Palette");if(a){var b=a.elements.namedItem("m_m");b=b instanceof HTMLSelectElement?b.selectedIndex:null;a=a.elements.namedItem("select");if(a instanceof HTMLSelectElement){switch(b){default:b=confirm("\u30d1\u30ec\u30c3\u30c8\u30de\u30c8\u30ea\u30af\u30b9\u3092\u30bb\u30c3\u30c8\u3057\u307e\u3059\u3002\n\u73fe\u5728\u306e\u5168\u30d1\u30ec\u30c3\u30c8\u60c5\u5831\u306f\u5931\u308f\u308c\u307e\u3059\u304c\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f");
break;case 1:b=confirm("\u30d1\u30ec\u30c3\u30c8\u30de\u30c8\u30ea\u30af\u30b9\u3092\u30bb\u30c3\u30c8\u3057\u307e\u3059\u3002\n\u73fe\u5728\u4f7f\u7528\u3057\u3066\u3044\u308b\u30d1\u30ec\u30c3\u30c8\u3068\u7f6e\u304d\u63db\u3048\u307e\u3059\u304c\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f");break;case 2:b=confirm("\u30d1\u30ec\u30c3\u30c8\u30de\u30c8\u30ea\u30af\u30b9\u3092\u30bb\u30c3\u30c8\u3057\u307e\u3059\u3002\n\u73fe\u5728\u306e\u30d1\u30ec\u30c3\u30c8\u60c5\u5831\u306b\u8ffd\u52a0\u3057\u307e\u3059\u304c\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f")}b&&
...
@endif
	...
	<div class="paintbbs_memo">
		...
		<div>
			&lt;ツールバー&gt;<br>値を変更するバーはドラッグ時バーの外に出した場合変化が緩やかになりますのでそれを利用して細かく変更する事が出来ます。<br>パレットはShift+クリックで色をデフォルトの状態に戻します。<br><br>&lt;キーボードのショートカット&gt;<br>Bで鉛筆,Eで消しゴム。<br>+で拡大-で縮小。<br>
			<br>Ctrl+ZかCtrl+Uで元に戻す、Ctrl+Alt+ZかCtrl+Yでやり直し。<br>Escでコピーやベジエのリセット。（右クリックでも同じ）
			<br>スペースキーを押しながらキャンバスをドラッグするとスクロールの自由移動。<br>左括弧 [ 、右括弧 ] 、Ctrl+Alt+ドラッグで線の幅を変更。<br><br>&lt;コピーツールの特殊な利用方法&gt;<br>レイヤー間の移動は現時点ではコピーとレイヤー結合のみです。コピーでの移動方法は、<br>まず移動したいレイヤー上の長方形を選択後、移動させたいレイヤーを選択後に通常のコピーの作業を<br>続けます。そうする事によりレイヤー間の移動が可能になります。<br>
		</div><br>
