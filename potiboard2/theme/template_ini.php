...
//テーマ(テンプレート)のバージョン
define('TEMPLATE_VER', "v1.18.7 lot.210306.0");
...
define('MSG045', "お絵かきアプリのファイルをアップロードしてください。[Please upload the file of the paint app.]<br>対応フォーマットはpch、spch、chiです。[Supported formats are pch, spch and chi.]");
